...
$lang['step_one_title'] = 'Auswahl der Terminart und des Arztes';
$lang['select_service'] = 'Auswahl der Terminart';
$lang['select_provider'] = 'Auswahl des Arztes';
$lang['duration'] = 'Dauer';
$lang['minutes'] = 'Minuten';
$lang['price'] = 'Preis';
$lang['back'] = 'Zurück';
$lang['step_two_title'] = 'Wählen Sie Ihren Termin';
...
$lang['cancel_appointment_hint'] = 'Bitte klicken Sie auf "Abbrechen" um den Termin aus dem Terminplan der Praxis zu löschen.';
...
$lang['reason'] = 'Grund';
$lang['appointment_removed_from_schedule'] = 'Der folgende Termin wurde erfolgreich von der Terminplanung der Praxis storniert.';
...
$lang['manage_appointment_record_hint'] = 'Verwalten Sie alle Termineintragungen der zur Verfügung stehenden Ärzte und Terminarten.';
$lang['select_filter_item_hint'] = 'Wählen Sie einen Arzt oder eine Terminart und sehen Sie die Termine im Kalender an.';
...
$lang['manage_services_hint'] = 'Verwalten Sie die verfügbaren Terminarten und Kategorien des Systems.';
$lang['manage_users_hint'] = 'Verwalten Sie die Endnutzer (Admins, Arzt, Praxispersonal).';
$lang['settings_hint'] = 'Setzen Sie das System aus Nutzereinstellungen.';
$lang['log_out_hint'] = 'Melden Sie sich vom System ab.';
$lang['unavailable_periods_hint'] = 'Über den Zeitraum nicht erhältlicher Terminarten werden neue Termin vom Arzt nicht akzeptiert.';
...
$lang['clear_fields_add_existing_customer_hint'] = 'Deaktivieren Sie die Felder und geben Sie einen neuen Patienten.';
...
$lang['providers'] = 'Ärzte';
$lang['secretaries'] = 'Koordinatoren';
...
$lang['provider_saved'] = 'Arzt erfolgreich gesichert!';
$lang['secretary_saved'] = 'Koordinator erfolgreich gesichert!';
$lang['admin_deleted'] = 'Administrator erfolgreich gelöscht!';
$lang['provider_deleted'] = 'Arzt erfolgreich gelöscht!';
$lang['secretary_deleted'] = 'Koordinator erfolgreich gelöscht!';
$lang['service_saved'] = 'Terminart erfolgreich gesichert!';
$lang['service_category_saved'] = 'Terminartkategorie erfolgreich gesichert!';
$lang['service_deleted'] = 'Terminart erfolgreich gelöscht!';
$lang['service_category_deleted'] = 'Terminartkategorie erfolgreicht gelöscht!';
...
$lang['about_app'] = 'Über Idana Calendar';
$lang['edit_working_plan_hint'] = 'Bitte notieren Sie im folgenden die Tage und Zeiten für die das Unternehmen Termine anbietet. Sie können Termine auch für Feiertage festlegen, aber die Patienten können an diesen Tagen keine Buchung durchführen. Dieser Arbeitsplan ist voreingestellt für alle neuen Einschreibungen von Dienstleistern, aber Sie haben die Möglichkeit den Arbeitsplan zu ändern und zwar für jeden Arzt gesondert, indem Sie seine Einschreibung bearbeiten. Danach fügen Sie die Zeiträume der Pausen hinzu.';
...
$lang['book_advance_timeout_hint'] = 'Legen Sie eine Zeitgrenze (in Minuten) fest bevor die Patienten eine Terminbuchung oder eine Terminänderungen durchführen können.';
$lang['timeout_minutes'] = 'Zeitgrenze (Minuten)';
$lang['about_app_info'] = 'Idana Calendar ist eine anpassungsfähige Internet-Applikation, die es Ihren Patienten ermöglicht, einen Termin mit Ihnen über des Internet zu schließen. Darüberhinaus gibt es Ihnen die Möglichkeit Ihre Daten mit dem Google Kalender zu synchronisieren, so dass Sie diese mit anderen Programmen nutzen können.';
$lang['current_version'] = 'Laufende Version';
$lang['support'] = 'Unterstützung';
$lang['about_app_support'] = 'Falls Sie irgendein Problem bei der Nutzung von Idana Calendar haben sollten können Sie die offizielle Google Gruppe nach Lösungen durchsuchen. Sie können auch ein neues Thema in Google Code beginnen, damit Sie die Findung von Lösungen unterstützen. ';
...
$lang['about_app_license'] = 'Idana Calendar ist lizensiert under der GPLv3-Lizenz. Bei Benutzung des Codes für Idana Calendar auf irgendeine Weise stimmen Sie mit den AGB der Tomes GmbH zu: https://idana.one/agb';
...
$lang['backend_section'] = 'Praxis-Oberfläche';
$lang['you_need_to_login'] = 'Willkommen! Sie müssen sich anmelden um die Praxis-Oberfläche zu sehen.';
...
$lang['backend_calendar'] = 'Praxis-Kalender';
...
$lang['add_break'] = 'Pause Hinzufügen';
$lang['january'] = 'Januar';
...
$lang['ea_update_success'] = 'Idana Calendar wurde erfolgreich aktualisiert!';
$lang['require_captcha'] = 'Erfordern CAPTCHA';
$lang['require_captcha_hint'] = 'Wenn Aktiv, werden die Patienten eine zufällig generierte Zeichenfolge (CAPTCHA) eintippen vor die eine Termin buchen/speichern dürfen.';
$lang['captcha_is_wrong'] = 'CAPTCHA Überprüfung fehlgeschlagen, bitte versuchen Sie es wieder.';
$lang['any_provider'] = 'Belieber Arzt';
...
$lang['customer_notifications'] = 'Patienten-Benachrichtigungen';
$lang['customer_notifications_hint'] = 'Stellen Sie ein, ob die Patienten eine E-Mail-Benachrichtigungen erhalten, jedes mal es gibt ein neue änderung auf ein Termin.';
...
$lang['at'] = 'um';
$lang['_h'] = ' Uhr';
$lang['your_booking'] = 'Ihr Termin';
$lang['your_data'] = 'Ihre Daten';
$lang['phone_number_mobile'] = 'Telefon (bevorzugt mobil)';
