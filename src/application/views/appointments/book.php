        ...
        <div id="book-appointment-wizard" class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
            ...
            <div id="wizard-frame-3" class="wizard-frame" style="display:none;">
                <div class="frame-container">
                    ...
                    <div class="frame-content column">
                        <div class="row">
                            <div class="form-group col-xs-12 col-sm-2">
                                <label for="salutation"><strong><?= lang('salutation') ?></strong></label>
                                <select id="salutation" class="form-control required" autocomplete="honorific-prefix">
                                    <option><?= lang('mister') ?></option>
                                    <option><?= lang('miss') ?></option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-xs-12 col-sm-5">
                                ...
                                <input type="text" id="last-name" class="required form-control"
                                       autocomplete="family-name" maxlength="120"/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12 col-sm-5">
                                ...
                                <input type="text" id="email" class="required form-control"
                                       autocomplete="home email" maxlength="120"/>
                            </div>
                            <div class="form-group col-xs-12 col-sm-4">
                                <label for="phone-number" class="control-label"><?= lang('phone_number_mobile') ?> *</label>
                                <input type="text" id="phone-number" class="required form-control"
                                       autocomplete="mobile tel" maxlength="60"/>
                            </div>
                            <div class="form-group col-xs-12 col-sm-3">
                                <label for="birth-date" class="control-label"><?= lang('birth_date') ?> *</label>
                                <input type="date" id="birth-date" name="birth-date" value="2000-01-01"
                                       autocomplete="bday" min="1900-01-01" class="required form-control"/>
                            </div>
                        </div>

                        <div class="row">
                            <div class="form-group col-xs-12 col-sm-5">
                                <label for="address" class="control-label"><?= lang('street') ?></label>
                            ...
                            <div class="form-group col-xs-12 col-sm-2">
                                ...
                                <input type="text" id="zip-code" class="form-control"
                                       autocomplete="postal-code" maxlength="120"/>
                            </div>
                            <div class="form-group col-xs-12 col-sm-5">
            ...
            <div id="frame-footer">
                Powered By
                <a href="https://idana.one" target="_blank">Idana Calendar</a>
                |
